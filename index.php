...
<main id="main">
	<section id="about" class="section">
		<div class="inner clr">
			...
			<div class="box">
				<h2 class="sectionTtl">
					<span class="langEn">
						<span class="block">Go Abroad Study</span>
						<span class="block">With Best Friends</span>
						<span class="block">In Your Life</span>
					</span>
					<span class="langJp">最高の仲間達と出会える留学を</span>
				</h2>
	...
	<section id="service" class="section animate change01">
		<div class="inner clr">
			<div class="box">
				...
				<p class="lead">テキストテキストテキストテキスト<br class="tb">
			...
			<div class="slider">
				<div class="slide slide01">
					<div class="slideDetail">
						...
						<div class="slideTxt">
							...
							<p>テキストテキストテキスト<br>テキストテキストテキストテキストテキスト<br>テキストテキストテキストテキスト</p>
						</div>
					</div>
				</div>
				<div class="slide slide02">
					<div class="slideDetail">
						...
						<div class="slideTxt">
							<h3 class="ttl">タイトル</h3>
							<p>こテキストテキスト<br>テキストテキスト<br>テキストテキストテキスト<br>テキストテキスト</p>
						</div>
					</div>
				</div>
				...
				<div class="slide slide04">
					<div class="slideDetail">
						...
						<div class="slideTxt">
							<h3 class="ttl">タイトル</h3>
							<p>テキストテキストテキストテキストテキスト<br>テキストテキスト<br>テキストテキストテキストテキストテキスト</p>
						</div>
					</div>
				</div>
				<div class="slide slide05">
					<div class="slideDetail">
						...
						<div class="slideTxt">
							<h3 class="ttl">タイトル</h3>
							<p>テキストテキストテキストテキスト<br>テキストテキスト<br>テキストテキストテキストテキスト</p>
						</div>
					</div>
				</div>
				<div class="slide slide06">
					<div class="slideDetail">
						...
						<div class="slideTxt">
							<h3 class="ttl">タイトル</h3>
							<p>テキストテキストテキスト<br>テキストテキストテキスト。<br>テキストテキストテキストテキストテキスト</p>
						</div>
					</div>
				</div>
				...
				<div class="slide slide08">
					<div class="slideDetail">
						...
						<div class="slideTxt">
							<h3 class="ttl">タイトル</h3>
							<p>テキストテキストテキスト<br>テキストテキストテキストテキスト<br>テキストテキストテキスト</p>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="sectionWrap">
		...
		<section id="works" class="section animate">
			<div class="inner clr">
				<div class="box">
					...
					<p class="lead">テキストテキスト<br>テキストテキストテキストテキスト</p>
		...
		<div id="gallery">
			<ul class="clr">
				<li><img src="<?php echo get_theme_file_uri( '/img/common/logo01.svg') ?>" alt="暮らしあと押しeo"></li>
				<li><img src="<?php echo get_theme_file_uri( '/img/common/logo01.svg') ?>" alt="大阪国際大学"></li>
				<li><img src="<?php echo get_theme_file_uri( '/img/common/logo01.svg') ?>" alt="KTC KYOTO TOOL"></li>
				<li><img src="<?php echo get_theme_file_uri( '/img/common/logo01.svg') ?>" alt="KURABO"></li>
				<li><img src="<?php echo get_theme_file_uri( '/img/common/logo01.svg') ?>" alt="Coleman"></li>
				<li><img src="<?php echo get_theme_file_uri( '/img/common/logo01.svg') ?>" alt="スシロー"></li>
				<li><img src="<?php echo get_theme_file_uri( '/img/common/logo01.svg') ?>" alt="人とモノの間に。TANAX"></li>
				<li><img src="<?php echo get_theme_file_uri( '/img/common/logo01.svg') ?>" alt="ytv"></li>
				...
				<ul class="clr">
					<li class="btnLink">
						<a href="/" target="_blank">
							<img class="logoGpol" src="<?#php echo get_theme_file_uri( '/img/common/logo01.svg') ?>" alt="Sample Gmbh.">
							<span>Sample Gmbh.<i></i></span>
						</a>
					</li>
					<li class="btnLink">
						<a href="/" target="_blank">
							<img class="logoTongullman" src="<?#php echo get_theme_file_uri( '/img/common/logo01.svg') ?>" alt="Sample Gmbh.">
							<span>Sample Gmbh.<i></i></span>
						</a>
					</li>
					<li class="btnLink">
						<a href="/" target="_blank">
							<img class="logoMegafoon" src="<?#php echo get_theme_file_uri( '/img/common/logo01.svg') ?>" alt="Sample Gmbh.">
							<span>Sample Gmbh.<i></i></span>
						</a>
					</li>
				</ul>
