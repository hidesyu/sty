...
<main id="main">
	...
	<section id="formContact" class="section">
		<div class="inner">
			...
			<div class="content animate">
				...
				<dl class="inquiryBox">
					...
					<dd>
						<ul class="clr">
							<li><span>大阪</span><a class="telLink" href="tel:06-6343-9327">06-6343-9327</a></li>
							<li><span>東京</span><a class="telLink" href="tel:03-6416-9208">03-6416-9208</a></li>
						</ul>
					</dd>
				</dl>
								<div class="formGroup">
					...
					<div class="formGroupDetail">
						<div class="checkBoxWrap">
									...
									<label for="formContactType02">弊社サービスに関するお問い合わせ</label>
								</div>
														<div class="checkBox">
				...
				<div class="formGroup rules">
					<dl>
						<dt>ご送信の前に、必ず「<a href="../privacypolicy/index.html" target="_blank">個人情報保護方針</a>」を<br class="sp">お読みのうえ、ご同意願います。</dt>
						<dd>
							<div class="checkBox">
				...
				<div class="btn btnForm btnSubmit btnBlack"><button id="confirm_next" value="入力内容を確認" disabled><span>入力内容を確認</span><svg class="iconArrowRight"><use xlink:href="#iconArrowRight"></use></svg></button></div>
			</div>
			</form>
		...
		<div class="inner clr">
			...
			<div class="btnContact"><a href="index.html"><span class="btnInner"><span><i class="fas fa-envelope-open"></i>お問い合わせはこちら</span></span></a></div>
		</div>
